...
def train():
    ...
    parser.add_argument('--normalization', required=False, type=bool, default=False) ###
    ###################################################################################
    ...
    parser.add_argument('--initial_lr', required=False, type=float, default=0.005)
    ...
    parser.add_argument('--n_layer', required=False, type=int, default=3)
    ...
    parser.add_argument('--dr_rate', required=False, type=float, default=0.1)
    ...
    if args.normalization:
        ...
        input = ((input - input_means) / input_stds) * r + b
        label = ((label - label_means) / label_stds) * r + b
    ...
    weight_path = "./code/weights/" + str(args.window_size)
    ...
    figure_path = "./code/figures/" + str(args.window_size) + "_loss_history.png"
