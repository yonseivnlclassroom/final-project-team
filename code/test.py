...
def test():
    ...
    weight_path = "./code/weights/" + str(args.window_size) + '/checkpoint_7994468864.000000_046'
    ...
    for i in range(len(label)):
        pred = ((test_output_pred[i] - b) * stds[-1] / r) + means[-1]
        y = ((label[i,-1] - b) * stds[-1] / r) + means[-1]
